...
const ChapterSection: React.FC = () => {
  ...
  const chapters: Chapter[] = [
    new Chapter(
      ...
      "Capítulo - 0: Invasão",
      "Invasão",
      "public/ChapterSection/prePages/Rithual pré pagina cap 0.png",
    ...
    new Chapter(
      ...
      "Capítulo - 1: Padaria",
      "Padaria",
      "public/ChapterSection/prePages/Rithual pré pagina cap 1.png",
    ...
    new Chapter(
      ...
      "Pai e irmão",
      "public/ChapterSection/prePages/Rithual pré pagina cap 2.png",
    ...
    new Chapter(
      ...
      "Capítulo - 3: Paisagem",
      "Paisagem",
      "public/ChapterSection/prePages/Rithual pré pagina cap 3.png",
    ...
    new Chapter(
      ...
      "Capítulo - 4: Escola",
      "Escola",
      "public/ChapterSection/prePages/Rithual pré pagina cap 4.png",
